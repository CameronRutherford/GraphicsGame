...
class Carpet : public graphics_object
{
private:
...
public:
	Carpet() : graphics_object("SkyCube") {}
	...
	void init_texture_map()
	{
		...
		int TexRight = MyLoadCubeMapBitmap("Textures\\floor.bmp", GL_TEXTURE_CUBE_MAP_POSITIVE_X);
		int TexLeft = MyLoadCubeMapBitmap("Textures\\floor.bmp", GL_TEXTURE_CUBE_MAP_NEGATIVE_X);
		int TexTop = MyLoadCubeMapBitmap("Textures\\floor.bmp", GL_TEXTURE_CUBE_MAP_POSITIVE_Y);
		int TexBottom = MyLoadCubeMapBitmap("Textures\\floor.bmp", GL_TEXTURE_CUBE_MAP_NEGATIVE_Y);
		int TexFront = MyLoadCubeMapBitmap("Textures\\floor.bmp", GL_TEXTURE_CUBE_MAP_POSITIVE_Z);
		int TexBack = MyLoadCubeMapBitmap("Textures\\floor.bmp", GL_TEXTURE_CUBE_MAP_NEGATIVE_Z);
