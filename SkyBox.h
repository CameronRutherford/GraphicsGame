...
public:
	...
	void init_texture_map()
	{
		...
		int TexRight = MyLoadCubeMapBitmap("skybox\\clouds_r.bmp", GL_TEXTURE_CUBE_MAP_POSITIVE_X);
		int TexLeft = MyLoadCubeMapBitmap("skybox\\clouds_l.bmp", GL_TEXTURE_CUBE_MAP_NEGATIVE_X);
		int TexTop = MyLoadCubeMapBitmap("skybox\\clouds_u.bmp", GL_TEXTURE_CUBE_MAP_POSITIVE_Y);
		int TexBottom = MyLoadCubeMapBitmap("skybox\\clouds_d.bmp", GL_TEXTURE_CUBE_MAP_NEGATIVE_Y);
		int TexFront = MyLoadCubeMapBitmap("skybox\\clouds_f.bmp", GL_TEXTURE_CUBE_MAP_POSITIVE_Z);
		int TexBack = MyLoadCubeMapBitmap("skybox\\clouds_b.bmp", GL_TEXTURE_CUBE_MAP_NEGATIVE_Z);
